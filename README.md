<a href="https://github.com/alahy011" target="_blank">
  <svg width="100%" height="140" viewBox="0 0 1000 140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Hamid Alami — Fullstack Developer">
    ...
    <defs>
      ...
      <!-- Border gradient (macOS blue/teal) -->
    ...
    <g transform="translate(20,20)">
      ...
      <rect x="0" y="0" rx="28" ry="28" width="960" height="100"
            fill="url(#glass)" stroke="url(#stroke)" stroke-width="1.25"
      ...
      <g transform="translate(40,72)">
        ...
        <text x="18" y="0"
              font-family="-apple-system,BlinkMacSystemFont,Segoe UI,Helvetica,Arial,Inter,system-ui,sans-serif"
              font-size="18" font-weight="600" fill="rgba(255,255,255,0.92)">
          Fullstack Developer
        </text>
      </g>
    </g>
